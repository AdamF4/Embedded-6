...
class S(BaseHTTPRequestHandler):
 ...
 def do_GET(self):
  self._set_headers()
  self.wfile.write(bytes("<html><body> <h1>Hello from "+device_name+"</h1><form method=POST><label>Device name: </label><input type=text name=device_name ><input type=submit value=Submit ></form></body></html>","utf-8"))
 def do_POST(self):
